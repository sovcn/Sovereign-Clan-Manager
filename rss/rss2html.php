...
$XMLfilename = "http://clandi.net/forums/index.php?act=rssout&id=1";
...
$limitItemDescriptionLength = 5;  // Not limited, in the URL as ItemDescriptionLength=
    ...
    if ($parseResult == 0) {
      ...
      if (!function_exists("FeedForALL_rss2html_replaceInItem")) {
        Function FeedForALL_rss2html_replaceInItem($source, $currentItem) {
          ...
          $item = FeedForAll_rss2html_str_replace("~~~ItemDescription~~~", truncate(strip_tags(FeedForAll_rss2html_limitLength($currentItem->description, $limitItemDescriptionLength)), 200), $item);
